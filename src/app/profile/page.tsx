                ...
                <TabsContent value="workout">
                  <div className="space-y-4">
                    ...
                    <Accordion type="multiple" className="space-y-4">
                      {currentPlan.workoutPlan.exercises.map((exerciseDays,index)=>(
                        <AccordionItem key={index} value={exerciseDays.day} className="border rounded-lg overflow-hidden">
                          <AccordionTrigger  className="px-4 py-3 hover:no-underline hover:bg-primary/10 font-mono">
                            <div className="flex justify-between w-full items-center">
                              <span className="text-primary">{exerciseDays.day}</span>
                              <div className="text-xs text-muted-foreground">
                                {exerciseDays.routines.length} EXERCISES
                              </div>
                            </div>
                          </AccordionTrigger>
                          ...
                          <AccordionContent className="pb-4 px-4">
                            <div className="space-y-3 mt-2">
                              {exerciseDays.routines.map((routine,routineIndex)=>(
                                <div key={routineIndex} className="border border-border rounded p-3 bg-background/50">
                                  <div className="flex justify-between items-start mb-2">
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div className="px-2 py-1 rounded bg-primary/20 text-secondary text-xs font-mono">
                                        {routine.reps} REPS
                                      </div>
                                    </div>
                                  </div>
